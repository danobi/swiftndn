...
open class Data: Tlv.Block {
    
    open class MetaInfo: Tlv.Block {
        
        open class ContentType: NonNegativeIntegerTlv {
        ...
        open class FreshnessPeriod: NonNegativeIntegerTlv {
        ...
        open class FinalBlockID: Tlv.Block {
            ...
            open override func wireEncode() -> [UInt8] {
    ...
    open class SignatureInfo: Tlv.Block {
        
        open class SignatureType: NonNegativeIntegerTlv {
        ...
        open class KeyLocator: Tlv.Block {
        ...
        open var signatureType = SignatureType()
        open var keyLocator: KeyLocator?
    ...
    open class SignatureValue: Tlv.Block {
    ...
    open var name = Name()
    open var metaInfo = MetaInfo()
    open var content = Content()
    open var signatureInfo = SignatureInfo()
    open var signatureValue = SignatureValue()
    ...
    open func getSignedPortion() -> [UInt8] {
    ...
    open class func wireDecode(_ bytes: [UInt8]) -> Data? {
